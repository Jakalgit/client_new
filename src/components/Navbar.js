                ...
                <Container>
                    ...
                    <Navbar.Collapse id="basic-navbar-nav">
                        <Nav className="me-auto offset-xxl-1 offset-xl-1 offset-lg-1">
                            ...
                            <Nav.Link className={NavBarCss.navbar_link} href="/deliveryandpay">Доставка и оплата</Nav.Link>
                            <Nav.Link className={NavBarCss.navbar_link} href="/basket">Корзина</Nav.Link>
                            <Nav.Link className={NavBarCss.navbar_link} href="/findyourorder">Ваш заказ</Nav.Link>
                ...
                <Container>
                    ...
                    <Navbar.Collapse id="basic-navbar-nav">
                        <Nav className="me-auto offset-xxl-1 offset-xl-1 offset-lg-1">
                            ...
                            <Nav.Link className={NavBarCss.navbar_link + ' ' + NavBarCss.navbar_link_user} href="/findyourorder">Ваш заказ</Nav.Link>
                            <Nav.Link className={NavBarCss.navbar_link + ' ' + NavBarCss.navbar_link_user} href="/deliveryandpay">Доставка и оплата</Nav.Link>
                        </Nav>
                    </Navbar.Collapse>
                </Container>
            }
