...
import {fetchOneOrderByNumber, fetchOrderItems} from "../http/itemAPI";
            ...
            {order !== null ?
                <div>
                    <div className={style_css.check_order}>
                        <div className="container">
                            <div className="row">
                                ...
                                <div
                                    className={style_css.left_block + ' col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12'}>
                    ...
                    <div className="item-block">
                        <div className="container">
                            <div className="row">
                                <h2 className={style_css.order_sum}><p className={style_css.text}>Сумма заказа:</p>{' ' + fullPrice + ' ₽'}</h2>
                                {orderItems.length !== 0 ?
                                    <div className="items">
                                        {orderItems.map(item =>
