...
import {
    ...
    CATALOG_ROUTE,
    CATEGORY_ROUTE,
    CATEGORYDOWN_ROUTE, CHANGEBRAND_ROUTE, CHANGECATEGORY_ROUTE, CHANGECATEGORYDOWN_ROUTE, CHANGEITEM_ROUTE,
    CHECKORDER_ROUTE,
    CREATEITEM_ROUTE,
    CREATEORDER_ROUTE,
    DELANDPAY_ROUTE,
    FIND_ROUTE,
    FINDCHANGE_ROUTE, FINDYOURORDER_ROUTE,
    HOME_ROUTE,
    ITEM_ROUTE, ORDERPAGE_ROUTE,
    ORDERS_ROUTE,
    THANKS_ROUTE, YOURORDER_ROUTE
} from "./utils/consts";
